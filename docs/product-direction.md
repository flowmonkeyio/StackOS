...
| Local readiness and repair loop v0 | Not started | `phase1-local-readiness-v0` | First implementation slice: install, first-run, doctor, desktop repair, and actionable repair hints as one loop. |
