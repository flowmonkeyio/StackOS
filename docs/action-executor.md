...
- `aws-s3`: one-bucket, optional-prefix-root object listing; conditional
  single/multipart upload/download; exact current-object deletion;
  directory-marker create; bounded prefix deletion; and non-atomic exact-object
  copy/delete rename
