...
def test_check_grant_for_system_skill_covers_bootstrap_setup_operations() -> None:
    ...
    check_grant("connection.list", SYSTEM_SKILL)
    check_grant("account.test", SYSTEM_SKILL)
    check_grant("account.session.status", SYSTEM_SKILL)
    check_grant("account.session.connect", SYSTEM_SKILL)
    check_grant("account.session.disconnect", SYSTEM_SKILL)
    ...
    check_grant("runPlan.getStep", SYSTEM_SKILL)
